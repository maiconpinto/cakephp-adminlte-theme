...
<!-- Ekko Lightbox -->
<?php echo $this->Html->css('AdminLTE./plugins/ekko-lightbox/ekko-lightbox', ['block' => true]); ?>
<?php echo $this->Html->script('AdminLTE./plugins/ekko-lightbox/ekko-lightbox.min', ['block' => true]); ?>

<!-- Filterizr-->
<?php echo $this->Html->script('AdminLTE./plugins/filterizr/jquery.filterizr.min', ['block' => true]); ?>
