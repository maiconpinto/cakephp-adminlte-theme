...
<!-- Ion Slider -->
<?php $this->Html->script('AdminLTE./plugins/ion-rangeslider/js/ion.rangeSlider.min', ['block' => true]); ?>
<!-- Bootstrap slider -->
<?php $this->Html->script('AdminLTE./plugins/bootstrap-slider/bootstrap-slider.min', ['block' => true]); ?>
