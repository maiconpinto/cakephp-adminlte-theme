...
<!-- SweetAlert2 -->
<?php echo $this->Html->css('AdminLTE./plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min', ['block' => true]); ?>
<!-- Toastr -->
<?php echo $this->Html->css('AdminLTE./plugins/toastr/toastr.min', ['block' => true]); ?>

  <!-- SweetAlert2 -->
<?php echo $this->Html->script('AdminLTE./plugins/sweetalert2/sweetalert2.min', ['block' => true]); ?>
<!-- Toastr -->
<?php echo $this->Html->script('AdminLTE./plugins/toastr/toastr.min', ['block' => true]); ?>
