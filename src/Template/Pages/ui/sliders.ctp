...
<!-- Ion Slider -->
<?php echo $this->Html->css('AdminLTE./plugins/ion-rangeslider/css/ion.rangeSlider.min', ['block' => true]); ?>
<!-- bootstrap slider -->
<?php echo $this->Html->css('AdminLTE./plugins/bootstrap-slider/css/bootstrap-slider.min', ['block' => true]); ?>

<!-- Ion Slider -->
<?php echo $this->Html->script('AdminLTE./plugins/ion-rangeslider/js/ion.rangeSlider.min', ['block' => true]); ?>
<!-- Bootstrap slider -->
<?php echo $this->Html->script('AdminLTE./plugins/bootstrap-slider/bootstrap-slider.min', ['block' => true]); ?>
