    ...
    <div class="row">
        ...
        <div class="card card-widget widget-user-2">
          ...
          <div class="widget-user-header bg-warning">
            <div class="widget-user-image">
              <?php echo $this->Html->image('AdminLTE.user7-128x128.jpg', ['class' => 'img-circle elevation-2', 'alt' =>'User Avatar']); ?>
            </div>
            <!-- /.widget-user-image -->
      ...
      <div class="col-md-4">
        ...
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-image">
            <?php echo $this->Html->image('AdminLTE.user1-128x128.jpg', ['class' => 'img-circle elevation-2', 'alt' =>'User Avatar']); ?>
          </div>
          <div class="card-footer">
            <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-header text-white"
               style="background: url('<?= $this->Url->assetUrl('AdminLTE./img/photo1.png') ?>') center center;">
            <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
            <h5 class="widget-user-desc text-right">Web Designer</h5>
          </div>
          <div class="widget-user-image">
            <?php echo $this->Html->image('AdminLTE.user3-128x128.jpg', ['class' => 'img-circle', 'alt' =>'User Avatar']); ?>
          </div>
          <div class="card-footer">
            <div class="row">
              <div class="col-sm-4 border-right">
        ...
        <div class="card card-widget">
          <div class="card-header">
            <div class="user-block">
              <?php echo $this->Html->image('AdminLTE.user1-128x128.jpg', ['class' => 'img-circle', 'alt' => 'User Image']); ?>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <?php echo $this->Html->image('AdminLTE.photo2.png', ['class' => 'img-fluid pad', 'alt' => 'Photo']); ?>
          ...
          <div class="card-footer card-comments">
            <div class="card-comment">
              <!-- User image -->
              <?php echo $this->Html->image('AdminLTE.user3-128x128.jpg', ['class' => 'img-circle img-sm', 'alt' => 'User Image']); ?>
            ...
            <div class="card-comment">
              <!-- User image -->
              <?php echo $this->Html->image('AdminLTE.user4-128x128.jpg', ['class' => 'img-circle img-sm', 'alt' => 'User Image']); ?>
          ...
          <div class="card-footer">
            <form action="#" method="post">
              <?php echo $this->Html->image('AdminLTE.user4-128x128.jpg', ['class' => 'img-fluid img-circle img-sm', 'alt' => 'Alt Text']); ?>
        ...
        <div class="card card-widget">
          ...
          <div class="card-body">
            ...
            <div class="attachment-block clearfix">
              <?php echo $this->Html->image('AdminLTE.photo1.png', ['class' => 'attachment-img', 'alt' => 'Attachment Image']); ?>
          ...
          <div class="card-footer card-comments">
            ...
            <div class="card-comment">
              <!-- User image -->
              <?php echo $this->Html->image('AdminLTE.user5-128x128.jpg', ['class' => 'img-circle img-sm', 'alt' => 'User Image']); ?>
