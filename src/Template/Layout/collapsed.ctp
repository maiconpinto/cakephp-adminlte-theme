<?php
$file = $theme['folder'] . DS . 'src' . DS . 'Template' . DS . 'Layout' . DS . 'collapsed.ctp';
if (file_exists($file)) {
    ob_start();
    include_once $file;
    echo ob_get_clean();
...
<body class="hold-transition skin-<?php echo isset($theme['skin']) ? $theme['skin'] : 'blue'; ?> sidebar-collapse sidebar-mini">
    <!-- Site wrapper -->
    <div class="wrapper">
