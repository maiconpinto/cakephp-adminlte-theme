...
<section class="content">
    <div class="row">
        <div class="col-md-3">
            <a href="<?= $this->Url->build('/pages/mailbox/compose') ?>" class="btn btn-primary btn-block mb-3">Compose</a>
                        ...
                        <table class="table table-hover table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="<?= $this->Url->build('/pages/mailbox/read-mail') ?>">Alexander Pierce</a></td>
