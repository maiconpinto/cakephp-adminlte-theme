...
<?= $this->Html->css('AdminLTE./plugins/ekko-lightbox/ekko-lightbox', ['block' => true]) ?>

<?= $this->Html->script([
    'AdminLTE.demo',
    'AdminLTE./plugins/jquery-ui/jquery-ui.min',
    'AdminLTE./plugins/ekko-lightbox/ekko-lightbox.min',
    'AdminLTE./plugins/filterizr/jquery.filterizr.min'
], ['block' => true]) ?>
