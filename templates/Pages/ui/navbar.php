 ...
 */
$this->assign('title', __('Navbar & Tabs'));
?>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <nav class="navbar navbar-expand navbar-light">
                                    ...
                                    <?= $this->Form->create(null, ['type' => 'get', 'class' => 'form-inline ml-3']) ?>
                                    <div class="input-group input-group-sm">
                                        <?= $this->Form->search('search', ['class' => 'form-control form-control-navbar', 'placeholder' => 'Search']) ?>
