 ...
 */
$this->assign('title', __('UI Ribbons'));
?>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                <div class="position-relative">
                                    <?= $this->Html->image('AdminLTE.photo1.png', ['alt' => 'Photo 1', 'class' => 'img-fluid']) ?>
                                    <div class="ribbon-wrapper ribbon-lg">
                                        <div class="ribbon bg-success text-lg">
                                            Ribbon
                                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="position-relative">
                                    <?= $this->Html->image('AdminLTE.photo2.png', ['alt' => 'Photo 2', 'class' => 'img-fluid']) ?>
                                    <div class="ribbon-wrapper ribbon-xl">
                                        <div class="ribbon bg-warning text-lg">
                                            Ribbon
                                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="position-relative" style="min-height: 180px;">
                                    <?= $this->Html->image('AdminLTE.photo3.jpg', ['alt' => 'Photo 3', 'class' => 'img-fluid']) ?>
                                    <div class="ribbon-wrapper ribbon-xl">
                                        <div class="ribbon bg-danger text-xl">
                                            Ribbon
                                        </div>
...
<?= $this->Html->script([
    'AdminLTE.demo',
    'AdminLTE./plugins/ion-rangeslider/js/ion.rangeSlider.min',
    'AdminLTE./plugins/bootstrap-slider/bootstrap-slider.min'
], ['block' => true]) ?>
