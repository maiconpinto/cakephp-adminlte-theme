                        ...
                        <td>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <?= $this->Html->image('AdminLTE.avatar.png', ['alt' => 'Avatar', 'class' => 'table-avatar']) ?>
                                </li>
                                <li class="list-inline-item">
                                    <?= $this->Html->image('AdminLTE.avatar2.png', ['alt' => 'Avatar', 'class' => 'table-avatar']) ?>
                                </li>
                                <li class="list-inline-item">
                                    <?= $this->Html->image('AdminLTE.avatar3.png', ['alt' => 'Avatar', 'class' => 'table-avatar']) ?>
                                </li>
                                <li class="list-inline-item">
                                    <?= $this->Html->image('AdminLTE.avatar4.png', ['alt' => 'Avatar', 'class' => 'table-avatar']) ?>
                                </li>
                            </ul>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <?= $this->Html->image('AdminLTE.avatar5.png', ['alt' => 'Avatar', 'class' => 'table-avatar']) ?>
                                </li>
                            </ul>
                        </td>
                        <td class="project_progress">
